    ...
    <div class="sidebar">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" data-accordion="false" role="menu">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.dashboardAdmin') }}" class="nav-link {{ request()->routeIs('dashboard.dashboardAdmin') ? 'active' : '' }}">
          ...
          @if(Auth::user() && Auth::user()->role === 'dokter')
            <li class="nav-item">
              <a href="{{ route('dokter.dashboardDokter') }}" class="nav-link {{ request()->routeIs('dashboard.dashboardDokter') ? 'active' : '' }}">
                <i class="nav-icon fas fa-home"></i>
          ...
          @if(Auth::user() && Auth::user()->role === 'pasien')
            <li class="nav-item">
              <a href="{{ route('pasien.dashboardPasien') }}" class="nav-link {{ request()->routeIs('dashboard.dashboardPasien') ? 'active' : '' }}">
                <i class="nav-icon fas fa-home"></i>
